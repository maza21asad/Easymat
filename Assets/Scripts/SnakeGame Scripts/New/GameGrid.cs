...
public class GameGrid : MonoBehaviour
{
    ...
    public int gridWidth = 12;      // Tall grid (editable)
    public int gridHeight = 24;     // Tall grid (editable)
    public float cellSize = 40f;    // UI space cell size

    [Header("References")]
    public RectTransform gamePanel; // Your GamePanel RectTransform
